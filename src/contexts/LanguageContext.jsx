...
const translations = {
  vi: {
    ...
    connection: "Kết nối",
    community: "Cộng đồng",
    connection_directory: "Danh bạ kết nối",
    ...
    sidebar_reading_mark: "Thước đọc",
    sidebar_reading_mark_desc: "Bật thước đọc ngang giúp theo dõi dòng nội dung đang xem",
    sidebar_highlight_links: "Liên kết",
    sidebar_highlight_links_desc: "Làm nổi bật các liên kết bằng gạch chân và nền dễ nhận biết",
    sidebar_sos: "SOS",
  ...
  en: {
    ...
    community: "Community",
    connection_directory: "Connection Directory",
    forum: "Forum",
    map: "Support Map",
    login: "Login",
    register: "Register",
    ...
    sidebar_reading_mark: "Reading",
    sidebar_reading_mark_desc: "Turn on a horizontal reading guide to follow the current line",
    sidebar_highlight_links: "Links",
    sidebar_highlight_links_desc: "Highlight links with underlines and a more visible background",
    sidebar_sos: "SOS",
